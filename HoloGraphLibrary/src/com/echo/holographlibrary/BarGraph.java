        ...
        if (fullImage == null || shouldUpdate) {
            ...
            for (Bar p : points) {
                ...
                if (showBarText) {
                    ...
                    if (popup != null)
                        popup.setBounds((int) (((r.left + r.right) / 2) - (this.p.measureText( p.getValue()+unit) / 2)) - 14, r.top + (r2.top - r2.bottom) - 26, (int) (((r.left + r.right) / 2) + (this.p.measureText( p.getValue()+ unit) / 2)) + 14, r.top);
                    popup.draw(canvas);
                    if (isAppended())
                        canvas.drawText(p.getValue() + unit, (int) (((r.left + r.right) / 2) - (this.p.measureText(p.getValue()+unit) / 2)), r.top - 20, this.p);
                    else
                        canvas.drawText(p.getValue()+unit, (int) (((r.left + r.right) / 2) - (this.p.measureText(p.getValue()+unit) / 2)), r.top - 20, this.p);
                }
