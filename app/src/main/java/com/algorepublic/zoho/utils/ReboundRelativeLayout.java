...
/**
 * Created by malikumarbhutta on 4/3/15.
 */
public class ReboundRelativeLayout extends RelativeLayout {
    ...
    public ReboundRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
     ...
     *
     * @param translateDirection {@link ReboundRelativeLayout.TranslateDirection} describing the direction to animate
     */
     ...
     *
     * @param listener {@link ReboundRelativeLayout.RevealListener}  listener for when animations complete
     */
